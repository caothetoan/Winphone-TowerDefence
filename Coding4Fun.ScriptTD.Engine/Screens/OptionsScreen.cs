    ...
    public class OptionsScreen : IScreen
    {
        ...
        private void RegisterInput()
        {
            if (_gui.Controls.ContainsKey("showgrid") && _gui.Controls["showgrid"] is CheckBox)
                _gui.Controls["showgrid"].Tapped += (c, v) => Settings.ShowGrid = ((CheckBox)c).Checked;
            ...
            if (_gui.Controls.ContainsKey("sfxdown"))
            {
                Action<IControl, Vector2> m = (c, v) =>
                {
                    ...
                    if (_gui.Controls.ContainsKey("sfxval"))
                        _gui.Controls["sfxval"].Value = _gui.Controls["sfxval"].Value <= 0 ? 0 : _gui.Controls["sfxval"].Value - 1;
                };
            ...
            if (_gui.Controls.ContainsKey("sfxup"))
            {
                Action<IControl, Vector2> m = (c, v) =>
                {
                    ...
                    if (_gui.Controls.ContainsKey("sfxval"))
                        _gui.Controls["sfxval"].Value = _gui.Controls["sfxval"].Value >= 100 ? 100 : _gui.Controls["sfxval"].Value + 1;
                };
            ...
            if (_gui.Controls.ContainsKey("musicdown"))
            {
                Action<IControl, Vector2> m = (c, v) =>
                {
                    ...
                    if (_gui.Controls.ContainsKey("musicval"))
                        _gui.Controls["musicval"].Value = _gui.Controls["musicval"].Value <= 0 ? 0 : _gui.Controls["musicval"].Value - 1;
                };
            ...
            if (_gui.Controls.ContainsKey("musicup"))
            {
                Action<IControl, Vector2> m = (c, v) =>
                {
                    ...
                    if (_gui.Controls.ContainsKey("musicval"))
                        _gui.Controls["musicval"].Value = _gui.Controls["musicval"].Value >= 100 ? 100 : _gui.Controls["musicval"].Value + 1;
                };
